import type { Transaction, DashboardSummary } from '@/lib/types';
...
export const sampleTransactions: Transaction[] = [
  ...
  { id: '4', date: '2023-10-04', remark: 'Dinner with friends', amount: 40, currency: 'USD', type: 'Debit' },
  ...
  { id: '10', date: '2023-10-01', remark: 'Freelance Project', amount: 800, currency: 'USD', type: 'Credit' },
];
